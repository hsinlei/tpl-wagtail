    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permalink', models.URLField(blank=True, verbose_name='Full Link')),
                ('linkedin_link', models.CharField(max_length=255, null=True)),
                ('position', models.CharField(max_length=255, null=True)),
                ('full_bio', wagtailmd.utils.MarkdownField(blank=True, verbose_name='Your personal bio')),
                ...
                ('personal_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.Image')),
            ],
            options={
                'abstract': False,
            },
